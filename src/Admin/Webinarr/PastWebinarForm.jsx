    ...
    try {
      ...
      if (selectedTutorImages) {
        const storageRef = ref(
          storage,
          `selectedTutorImages2/${auth.currentUser.uid}/${allId}`
        );
      ...
      if (selectedImage) {
        const storageRef = ref(
          storage,
          `pastWebinarThumbnail/${auth.currentUser.uid}/${allId}`
        );
      ...
      if (adminSnapshot.exists()) {
        ...
        const currentComingSoon = adminSnapshot.data().pastWebinar || [];
        await updateDoc(adminRef, {
          pastWebinar: [...currentComingSoon, postObject],
        });
      } else {
        // Create a new document
        await setDoc(adminRef, {
          pastWebinar: [postObject],
        });
      }
    ...
    <div className="bgi">
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 col-lg-6 mb-4">
            <div>
              <div className="cacus">Video URL</div>
              <div>
                <input
                  type="text"
                  className="feeelz"
